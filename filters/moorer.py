...
if __name__ == '__main__':
    wavfile = '../wave_file/acoustic.wav'
    output_wavfile = '../wave_file/out_moorerreverb_python.wav'
    ...
    cd, g1, g2, cg, cg1, ag, ad, k, states_list = moorer_pre(RATE)
    
    # ------------------- separate frame -------------------
    while len(binary_data) == WIDTH*BLOCKLEN:
        input_block = struct.unpack('h'*BLOCKLEN, binary_data)
        
        [output_block, b, a], states_list = moorer(input_block, cg, cg1, cd, ag, ad, k, states_list)
