...
# schroeder UI
SCHROWDERINFO = Tk.Label(schroederFrame, text='Reverb Schroeder')
...
# moorer UI
MOORERINFO = Tk.Label(moorerFrame, text='Reverb Moorer')
...
shelvingType = Tk.Listbox(shelvingFrame, width=30)
...
# tremolo2 UI
TREMOLO2INFO = Tk.Label(tremolo2Frame, text='Tremolo2')
...
# tremolo2 UI
WAHWAHINFO = Tk.Label(wahwahFrame, text='Wah Wah')
...
while CONTINUE:
    ...
    if shelvingType.curselection() and shelvingType.curselection()[0]:
        ...
        if click == 1:
            y, states_base_shel = shelving(b_base_shel, a_base_shel, y, states_base_shel)
        elif click == 2:
            y, states_treb_shel = shelving(b_treb_shel, a_treb_shel, y, states_treb_shel)
        else:
            pass
    ...
    if WAHWAHSTATUS:
        wah_wah_gain = 1
        y, Fc_wah_wah, wah_wah_pair = wah_wah(y*wah_wah_gain, Fc_wah_wah, RATE, wah_wah_pair)
